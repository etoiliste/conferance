package org.detaysoft.panel
{
	...
	public class DragPanel extends Panel
	{
		...
		[Bindable]
		[Embed(source="assets/resize.png")] 
		private var mouseCursor:Class;
		...
		private function creationCompleteHandler(event:Event):void
		{
			...
			addEventListener(MouseEvent.MOUSE_OVER,function(event:MouseEvent):void{
				var lowerLeftX:Number = x + width + 10; 
				var lowerLeftY:Number = y + height + 10;
				...
				if (upperLeftX <= panelRelX && panelRelX <= lowerLeftX)
				{
					...
					{		
						cursorID = CursorManager.setCursor(mouseCursor); 
					}
				}	
		...
		override protected function updateDisplayList(unscaledWidth:Number, unscaledHeight:Number):void
		{
			...
			minShape.graphics.drawRect(unscaledWidth - 60, 20, 20, 20);
